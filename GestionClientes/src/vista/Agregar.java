...
public class Agregar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbx_comuna.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccionar", "Viña del Mar", "Valparaíso", "Quilpué", "Limache", "Concón", "Villa Alemana", "La Ligua", "Petorca", "Los Andes" }));
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        try {
            ...
            if (Registro.agregarCliente(cli)) {
                ...
                int confirmado = JOptionPane.showConfirmDialog(null, "¿Desea volver al menu principal?", "Confirmación", 2);
